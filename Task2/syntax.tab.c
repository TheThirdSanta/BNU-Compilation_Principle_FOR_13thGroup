...
{
       0,    48,    48,    53,    57,    63,    68,    72,    81,    84,
      96,    99,   104,   111,   118,   121,   126,   134,   137,   145,
     151,   158,   163,   168,   177,   185,   189,   195,   199,   202,
     207,   214,   223,   230,   242,   246,   251,   259,   262,   270,
     273,   283,   288,   293,   298,   303,   308,   313,   318,   323,
     328,   332,   336,   342,   347,   353,   358,   361,   364,   367,
     373,   379,   385,   391,   401,   406
};
#endif
...
#line 48 "syntax.y"
                     {
        yyval = insertNode(yyvsp[0], "Program", yyvsp[0]->lineNum, NONTERMINAL);
    }
