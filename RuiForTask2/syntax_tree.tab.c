...
union YYSTYPE
{
#line 12 "syntax_tree.y"

    tnode type_tnode;
	// 这里声明double是为了防止出现指针错误（segmentation fault）
	double d;

#line 171 "syntax_tree.tab.c"
...
#line 1543 "syntax_tree.tab.c"
    break;

  case 19:
#line 72 "syntax_tree.y"
...
#line 1555 "syntax_tree.tab.c"
    break;

  case 21:
#line 75 "syntax_tree.y"
...
#line 1675 "syntax_tree.tab.c"
    break;

  case 41:
#line 108 "syntax_tree.y"
                    {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1681 "syntax_tree.tab.c"
    break;

  case 42:
#line 109 "syntax_tree.y"
                   {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1687 "syntax_tree.tab.c"
    break;

  case 43:
#line 110 "syntax_tree.y"
                      {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1693 "syntax_tree.tab.c"
    break;

  case 44:
#line 111 "syntax_tree.y"
                     {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1699 "syntax_tree.tab.c"
    break;

  case 45:
#line 112 "syntax_tree.y"
                      {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1705 "syntax_tree.tab.c"
    break;

  case 46:
#line 113 "syntax_tree.y"
                     {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1711 "syntax_tree.tab.c"
    break;

  case 47:
#line 114 "syntax_tree.y"
                    {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1717 "syntax_tree.tab.c"
    break;

  case 48:
#line 115 "syntax_tree.y"
                  {(yyval.type_tnode)=newAst("Exp",3,(yyvsp[-2].type_tnode),(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1723 "syntax_tree.tab.c"
    break;
...
#line 1729 "syntax_tree.tab.c"
    break;

  case 50:
#line 117 "syntax_tree.y"
                 {(yyval.type_tnode)=newAst("Exp",2,(yyvsp[-1].type_tnode),(yyvsp[0].type_tnode));nodeList[nodeNum]=(yyval.type_tnode);nodeNum++;}
#line 1735 "syntax_tree.tab.c"
    break;
